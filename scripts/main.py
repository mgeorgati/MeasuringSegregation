...
def main(city):
    if city == 'grootams':
        ...
        srcNameDef = 'Dasy_16unet_10epochspi_15AIL7_it5' #----------
    
    
    for scenario in [ 'bch']: #'bs', 'war','re' 'bch', 'eur','re', 'hist', 'bch','bs'
        if scenario =='hist': 
        ...
        for i in range(len(years_list)):
            ...
            for attr_value in attr_values:
                process_Projections(city, scenario, attr_value, year, srcNameDef,
                        ...
                        plotMaps100 = 'no', plotMapsAggr = 'no',
                        )
                ...
                process_KNN(city, scenario, attr_value, year, srcNameDef,
                        ...
                        estimate_sum_knn = 'no', init_raster_shp= 'no') #HEEEERRE
            ...
            process_ProjectionsTotal(city, scenario, attr_values, year,
                        init_shp_gpkg='no',  init_point_cell ='no', init_calc_summary ='no', init_calc_dis='no', calcSums= 'yes'
                        )
    ...
    for scenario in [ 'hist']: #'bs', 'war','re' 'bch', 'eur','re', 'hist', 'bch','bs'
        ...
        for i in range(len(years_list)):
            ...
            for attr_value in attr_values:
                ...
                process_KNN(city, scenario, attr_value, year, srcNameDef,
                        calc_KNNneigh = 'no', templatePath = templatePath, yearPrevious = yearPrevious, calc_Conv='no', plot_knn = 'no', plot_knn_dif= 'no',
                        estimate_sum_knn = 'yes', init_raster_shp= 'yes') #HEEEERRE
            ...
            process_KNN_total(city,scenario, attr_values, year, init_shp_gpkg= 'yes', removeFilles='no')
